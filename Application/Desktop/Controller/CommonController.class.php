...
//                }
    ...
    public function check($ckUid,$token){
        ...
        $status=$array['status'];
        // file_put_contents('logs1.txt', '===========>'. date('Y-m-d H:i:s') .PHP_EOL, FILE_APPEND);
        // file_put_contents('logs1.txt', $token.PHP_EOL, FILE_APPEND);
        // file_put_contents('logs1.txt', $ckUid.PHP_EOL, FILE_APPEND);
        // file_put_contents('logs1.txt', $res.PHP_EOL, FILE_APPEND);
        if($status==1){
            return 226200;
        }else{
            return 226400;
